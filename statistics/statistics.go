...
func NumberOfRedeemedDiscounts() {

}

// GroupByCategoryAndCount Returns how many times a category was redeemed
func GroupByCategoryAndCount() {
...
func GetWeekDayForMostRedeemsForGivenCategory(category *models.Category) {

}

func GetMonthPeriodForMostRedeems(month time.Month) {
